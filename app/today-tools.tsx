...
const days = [
  { day: "01", date: "1 AGO", title: "Zamora → Miranda → Bragança", base: "Hotel / hostal en Bragança", drive: "465 km · 5 h 50", normal: ["Salida antes de las 08:00", "Zamora: casco histórico y Duero", "Miranda do Douro y miradores", "Llegada y cena en Bragança"], calm: ["Zamora como parada principal", "Mirador breve en Miranda", "Llegada temprana a Bragança"], rain: ["Catedral de Zamora", "Catedral de Miranda", "Llegada temprana al hotel"], alternative: "Si se acumula retraso, reducir Miranda a un paseo de 45 minutos.", event: "No añadir eventos: la prioridad es llegar a Bragança sin conducir de noche.", maps: "https://www.google.com/maps/dir/42.8467,-2.6716/41.5035,-5.7446/41.4966,-6.2737/41.8061,-6.7567" },
  { day: "02", date: "2 AGO", title: "Bragança → Lima Escape", base: "Lima Escape · noche 1/3", drive: "205 km · 3 h", normal: ["Ciudadela y castillo", "Comida temprana", "Salida antes de las 14:30", "Llegada, montaje y río Lima"], calm: ["Paseo por la ciudadela", "Traslado directo", "Montaje con luz"], rain: ["Museo de la Máscara", "Castillo", "Traslado temprano"], alternative: "No añadir Soajo: reservarlo para el día 3.", event: "La Noite do Folclore de Arcos no compensa después del traslado.", maps: "https://www.google.com/maps/dir/41.8061,-6.7567/41.824395,-8.318062" },
  { day: "03", date: "3 AGO", title: "Soajo + Lindoso", base: "Lima Escape · noche 2/3", drive: "36 km · 45 min de marcha; reservar 1 h 15", normal: ["Soajo y espigueiros", "Poço Negro", "Comida local", "Castillo y espigueiros de Lindoso"], calm: ["Soajo", "Poço Negro", "Regreso temprano"], rain: ["Soajo", "Castillo de Lindoso", "Centros de interpretación"], alternative: "No añadir Sistelo: ahora dispone de una jornada completa el día 4.", event: "Consultar la agenda de Arcos únicamente si apetece prolongar la tarde.", maps: "https://www.google.com/maps/dir/41.824395,-8.318062/41.8721,-8.2634/41.8662,-8.1998/41.824395,-8.318062" },
  { day: "04", date: "4 AGO", title: "Sistelo + Arcos de Valdevez", base: "Lima Escape · noche 3/3", drive: "105 km · 2 h 20 realistas", normal: ["Sistelo y bancales", "Tramo corto de la Ecovia do Vez", "Comida en Arcos", "Centro y Praia Fluvial da Valeta"], calm: ["Sistelo y miradores", "Arcos de Valdevez", "Baño en la Valeta"], rain: ["Paço de Giela", "Centro de Arcos", "Museu da Água"], alternative: "La Ecovia completa es lineal: reservar taxi; con cansancio, limitarse a 5–7 km.", event: "Comprobar la agenda municipal de Arcos para conciertos o folclore al final del día.", maps: "https://www.google.com/maps/dir/41.824395,-8.318062/41.9733,-8.3746/41.8467,-8.4191/41.824395,-8.318062" },
  { day: "05", date: "5 AGO", title: "Braga → Cabedelo", base: "Traslado", drive: "125 km · 2 h 15", normal: ["Desmontaje", "Bom Jesus", "Braga y comida", "Montaje en Cabedelo"], calm: ["Bom Jesus", "Traslado y montaje"], rain: ["Sé de Braga", "Museu dos Biscainhos", "Traslado"], alternative: "Eliminar Sameiro antes que acortar Braga.", event: "O Mundo a Dançar · Arcos · 22:00; solo si se acepta regresar hacia el interior.", maps: "https://www.google.com/maps/dir/41.824395,-8.318062/41.5547,-8.3771/41.5518,-8.4229/41.678611,-8.823056" },
  { day: "06", date: "6 AGO", title: "Viana + Santa Luzia", base: "INATEL Cabedelo", drive: "30 km · 50 min", normal: ["Centro de Viana", "Gil Eannes", "Comida", "Santa Luzia", "Cabedelo"], calm: ["Viana", "Gil Eannes", "Cabedelo"], rain: ["Gil Eannes", "Museu do Traje", "Centro histórico"], alternative: "No subir a Santa Luzia con nube cerrada.", event: "Consultar la agenda de Viana para actividades nocturnas.", maps: "https://www.google.com/maps/dir/41.678611,-8.823056/41.6932,-8.8329/41.7044,-8.8342/41.678611,-8.823056" },
  { day: "07", date: "7 AGO", title: "Costa norte", base: "INATEL Cabedelo", drive: "90 km · 2 h", normal: ["Praia de Afife", "Vila Praia de Âncora", "Moledo", "Caminha y cena"], calm: ["Afife o Moledo", "Caminha"], rain: ["Caminha", "Cerveira", "Comida larga"], alternative: "Elegir dos playas como máximo.", event: "SonicBlast y Festa do Mar e da Sardinha en Âncora; encajan perfectamente.", maps: "https://www.google.com/maps/dir/41.678611,-8.823056/41.7812,-8.8725/41.8158,-8.8695/41.8496,-8.8664/41.8753,-8.8387/41.678611,-8.823056" },
  { day: "08", date: "8 AGO", title: "Valença + Tui", base: "Traslado", drive: "120 km · 2 h", normal: ["Desmontaje", "Valença", "Tui", "Montaje en Santa Tecla"], calm: ["Valença", "Montaje temprano"], rain: ["Catedral de Tui", "Fortaleza de Valença", "Montaje"], alternative: "Cerveira sustituye Tui si se prefiere arte y menos paseo.", event: "Sons no Terreiro · Cerveira · 21:30; opción nocturna recomendada.", maps: "https://www.google.com/maps/dir/41.678611,-8.823056/42.0308,-8.6459/42.0472,-8.6444/41.8897,-8.8464" },
  { day: "09", date: "9 AGO", title: "Santa Trega + A Guarda", base: "Camping Santa Tecla", drive: "25 km · 45 min", normal: ["Castro de Santa Trega", "Miradores", "Puerto de A Guarda", "Cena"], calm: ["Subida en coche", "Castro", "Puerto"], rain: ["MASAT", "Museo del castro", "Puerto y cafés"], alternative: "Sendero Azul sustituye la subida a pie.", event: "Feira de Artes e Velharias en Cerveira; alternativa si el monte está cubierto.", maps: "https://www.google.com/maps/dir/41.8897,-8.8464/41.8925,-8.8697/41.9012,-8.8747/41.8897,-8.8464" },
  { day: "10", date: "10 AGO", title: "Oia + Mougás + Baiona", base: "Camping Santa Tecla", drive: "95 km · 2 h", normal: ["Monasterio de Oia", "Pozas de Mougás", "Cabo Silleiro", "Baiona"], calm: ["Oia", "Cabo Silleiro", "Baiona"], rain: ["Monasterio de Oia", "Exposiciones Baiverán", "Casco de Baiona"], alternative: "Eliminar Mougás si llueve o la roca está húmeda.", event: "Consultar Baiverán y la agenda de Baiona para el cierre del día.", maps: "https://www.google.com/maps/dir/41.8897,-8.8464/42.0024,-8.8767/42.0581,-8.8662/42.1012,-8.8974/42.1209,-8.8492/41.8897,-8.8464" },
  { day: "11", date: "11 AGO", title: "Regreso o extensión", base: "Fecha abierta", drive: "0–650 km", normal: ["Comprobar tiempo y cansancio", "Elegir regreso o noche extra", "Si se permanece: playa, Caminha, Baiona o Vigo"], calm: ["Noche extra", "Descanso y playa cercana"], rain: ["Regreso directo", "O museo y noche adicional"], alternative: "Regresar el 12 o ampliar hasta el 13 con una etapa intermedia.", event: "Elegir agenda solo después de confirmar la nueva fecha de regreso.", maps: "https://www.google.com/maps/dir/41.8897,-8.8464/42.8467,-2.6716" },
] as const;

const parking = {
  "01": ["Casco histórico de Zamora", "Exterior del centro de Miranda", "Variable", "Autovía + carretera convencional", "5–15 min", "Zamora antes de 11:30", "41.5035, -5.7446"],
  "02": ["Entorno de la ciudadela de Bragança", "Alojamiento o zona exterior de murallas", "Media", "Acceso urbano; después carretera interior", "5–12 min", "Salir antes de 14:30", "41.8061, -6.7567"],
  "03": ["Entrada de Soajo + castillo de Lindoso", "Calles exteriores sin bloquear vecinos", "Pequeña", "Carretera estrecha y sinuosa", "5–15 min", "Antes de 09:30", "41.8721, -8.2634"],
  "04": ["Entrada de Sistelo + centro de Arcos", "Miradores señalizados y parking de la Valeta", "Pequeña en Sistelo", "Carreteras locales estrechas", "5–15 min", "Sistelo antes de 09:30", "41.9733, -8.3746"],
  "05": ["Parking superior de Bom Jesus", "Parking del funicular", "Media", "Urbano y asfaltado", "5–15 min", "Antes de 10:00", "41.5547, -8.3771"],
  "06": ["Campo d’Agonia", "Parking de la Marina", "Grande", "Acceso urbano", "8–15 min al centro", "Antes de 11:00", "41.6932, -8.8329"],
  "07": ["Aparcamientos oficiales de playa", "Estación de Caminha", "Variable", "N13 lenta en agosto", "3–12 min", "Playas antes de 10:30", "41.7812, -8.8725"],
  "08": ["Exterior de la fortaleza de Valença", "Área Panorámica de Tui", "Grande", "Evitar entrar en calles históricas", "5–12 min", "Añadir 30 min con fiestas", "42.0308, -8.6459"],
  "09": ["Castro y cima de Santa Trega", "A Guarda y subida parcial a pie", "Pequeña", "Subida estrecha y sujeta a tasa", "2–15 min", "Antes de 10:00", "41.8925, -8.8697"],
  "10": ["Oia + parking Aral de Baiona", "Apartaderos autorizados de Mougás", "Pequeña en Mougás", "PO-552 con curvas", "5–15 min", "Baiona antes de 17:00", "42.0024, -8.8767"],
  "11": ["Áreas de servicio planificadas", "Paradas cada 2–2,5 h", "Grande", "Autovía", "0–5 min", "Salir antes de 10:00", "41.8897, -8.8464"],
} as const;
...
function baseForDay(day: string) {
  return Number(day) <= 5 ? "1" : Number(day) <= 7 ? "2" : "3";
}

export default function TodayTools({ weather, openDay, openSection }: Props) {
  const initialDay = typeof window !== "undefined" && new Date().getMonth() === 7 && new Date().getDate() <= 11 ? String(new Date().getDate()).padStart(2, "0") : "01";
