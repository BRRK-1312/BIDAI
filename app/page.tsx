...
const stops: Stop[] = [
  ...
  { name: "Lima Escape", day: "Días 2–4", date: "2–5 AGO", base: 1, coords: [41.824395, -8.318062], note: "Base interior durante tres noches: bosque, río Lima y Peneda–Gerês", kind: "camping" },
  ...
  { name: "Sistelo", day: "Día 4", date: "4 AGO", base: 1, coords: [41.9733, -8.3746], note: "Aldea de bancales, miradores y acceso a la Ecovia do Vez", kind: "nature" },
  { name: "Arcos de Valdevez", day: "Día 4", date: "4 AGO", base: 1, coords: [41.8467, -8.4191], note: "Centro histórico, paseo del Vez y baño fluvial en la Valeta", kind: "town" },
  { name: "Bom Jesus do Monte", day: "Día 5", date: "5 AGO", base: 1, coords: [41.5547, -8.3771], note: "Santuario, escalinata y funicular hidráulico", kind: "history" },
  { name: "Braga", day: "Día 5", date: "5 AGO", base: 1, coords: [41.5518, -8.4229], note: "Sé, centro histórico y gastronomía del Minho", kind: "town" },
  { name: "INATEL Cabedelo", day: "Días 5–7", date: "5–8 AGO", base: 2, coords: [41.678611, -8.823056], note: "Segunda base con acceso directo a la playa", kind: "camping" },
  { name: "Viana do Castelo", day: "Día 6", date: "6 AGO", base: 2, coords: [41.6932, -8.8329], note: "Centro histórico, Gil Eannes y paseo marítimo", kind: "town" },
  { name: "Santa Luzia", day: "Día 6", date: "6 AGO", base: 2, coords: [41.7044, -8.8342], note: "Basílica y gran mirador sobre el Lima", kind: "history" },
  { name: "Praia de Afife", day: "Día 7", date: "7 AGO", base: 2, coords: [41.7812, -8.8725], note: "Playa atlántica extensa y salvaje", kind: "beach" },
  { name: "Vila Praia de Âncora", day: "Día 7", date: "7 AGO", base: 2, coords: [41.8158, -8.8695], note: "Puerto, paseo y Forte da Lagarteira", kind: "town" },
  { name: "Praia de Moledo", day: "Día 7", date: "7 AGO", base: 2, coords: [41.8496, -8.8664], note: "Surf, pinar y vistas al Forte da Ínsua", kind: "beach" },
  { name: "Caminha", day: "Día 7", date: "7 AGO", base: 2, coords: [41.8753, -8.8387], note: "Casco histórico y desembocadura del Miño", kind: "town" },
  { name: "Valença do Minho", day: "Día 8", date: "8 AGO", base: 3, coords: [42.0308, -8.6459], note: "Fortaleza fronteriza y murallas", kind: "history" },
  { name: "Tui", day: "Día 8", date: "8 AGO", base: 3, coords: [42.0472, -8.6444], note: "Catedral, calles medievales y río Miño", kind: "town" },
  { name: "Camping Santa Tecla", day: "Días 8–11/13", date: "8–13 AGO", base: 3, coords: [41.8897, -8.8464], note: "Tercera base junto al estuario del Miño; salida flexible", kind: "camping" },
  { name: "Monte Santa Trega", day: "Día 9", date: "9 AGO", base: 3, coords: [41.8925, -8.8697], note: "Castro y miradores sobre Portugal y el Atlántico", kind: "history" },
  { name: "A Guarda", day: "Día 9", date: "9 AGO", base: 3, coords: [41.9012, -8.8747], note: "Puerto pesquero, cetáreas y cocina marinera", kind: "town" },
  { name: "Monasterio de Oia", day: "Día 10", date: "10 AGO", base: 3, coords: [42.0024, -8.8767], note: "Monasterio cisterciense frente al océano", kind: "history" },
  { name: "Pozas de Mougás", day: "Día 10", date: "10 AGO", base: 3, coords: [42.0581, -8.8662], note: "Pozas, molinos y paisaje de costa", kind: "nature" },
  { name: "Cabo Silleiro", day: "Día 10", date: "10 AGO", base: 3, coords: [42.1012, -8.8974], note: "Faro, acantilados y baterías costeras", kind: "nature" },
  { name: "Baiona", day: "Día 10", date: "10 AGO", base: 3, coords: [42.1209, -8.8492], note: "Monterreal, casco histórico y paseo marítimo", kind: "town" },
];
...
const dayRoutes = [
  ...
  { day: "08", title: "Valença + Tui", color: "#386d65", points: [[41.678611, -8.823056], [42.0308, -8.6459], [42.0472, -8.6444], [41.8897, -8.8464]] },
  { day: "09", title: "Santa Trega", color: "#2f7d5b", points: [[41.8897, -8.8464], [41.8925, -8.8697], [41.9012, -8.8747], [41.8897, -8.8464]] },
  { day: "10", title: "Costa de Oia", color: "#2f7d5b", points: [[41.8897, -8.8464], [42.0024, -8.8767], [42.0581, -8.8662], [42.1012, -8.8974], [42.1209, -8.8492], [41.8897, -8.8464]] },
  { day: "11", title: "Regreso flexible", color: "#20201d", points: [[41.8897, -8.8464], [42.8467, -2.6716]] },
] as const;
...
const walkingRoutes = [
  ...
  { day: "04", title: "ECOVIA DO VEZ · SISTELO", points: [[41.9733, -8.3746], [41.957, -8.383]] },
  { day: "06", title: "VIANA A PIE", points: [[41.6932, -8.8329], [41.7044, -8.8342]] },
  { day: "09", title: "CAMIÑOS DO TREGA", points: [[41.9012, -8.8747], [41.8925, -8.8697]] },
  { day: "10", title: "POZAS DE MOUGÁS", points: [[42.0558, -8.8492], [42.0581, -8.8662]] },
] as const;
...
const dailyPlans = [
  ...
  {
    day: "02", date: "DOM · 2 AGO", drive: "≈ 205 KM · 3 H", base: "LIMA ESCAPE · NOCHE 1/3",
  ...
  {
    day: "03", date: "LUN · 3 AGO", drive: "≈ 36 KM · 45 MIN DE MARCHA; RESERVAR 1 H 15", base: "LIMA ESCAPE · NOCHE 2/3",
  ...
  {
    day: "04", date: "MAR · 4 AGO", drive: "≈ 105 KM · 2 H 20 REALISTAS", base: "LIMA ESCAPE · NOCHE 3/3",
    schedule: ["Salida temprana hacia Sistelo", "Miradores, bancales y paseo corto por la Ecovia do Vez", "Comida en Arcos de Valdevez", "Centro histórico y Praia Fluvial da Valeta", "Regreso a Lima Escape"],
    walk: "Tranquilo: Sistelo y miradores · 2–3 km / normal: tramo corto de la Ecovia · 5–7 km / completo: Vilela → Sistelo · 10,5 km lineal",
  ...
  {
    day: "06", date: "JUE · 6 AGO", drive: "≈ 30 KM · 50 MIN", base: "INATEL CABEDELO · NOCHE 2/3",
  ...
  {
    day: "07", date: "VIE · 7 AGO", drive: "≈ 90 KM · 2 H", base: "INATEL CABEDELO · NOCHE 3/3",
  ...
  {
    day: "08", date: "SÁB · 8 AGO", drive: "≈ 120 KM · 2 H", base: "TRASLADO A CAMPING SANTA TECLA · NOCHE 1/3",
  ...
  {
    day: "09", date: "DOM · 9 AGO", drive: "≈ 25 KM · 45 MIN", base: "CAMPING SANTA TECLA · NOCHE 2/3",
  ...
  {
    day: "10", date: "LUN · 10 AGO", drive: "≈ 95 KM · 2 H", base: "CAMPING SANTA TECLA · NOCHE 3/3",
  ...
  {
    day: "11", date: "MAR · 11 AGO", drive: "0–650 KM · FECHA ABIERTA", base: "DECIDIR: REGRESO O NOCHE EXTRA",
    schedule: ["Comprobar tiempo, cansancio y disponibilidad del camping", "Opción A: desmontar temprano y volver a Vitoria", "Opción B: conservar la parcela y dedicar el día a playa, Caminha, Baiona o Vigo", "Si se amplía: fijar regreso para el 12 o 13"],
    ...
    pace: { tranquilo: "Mantener una noche extra y descansar.", normal: "Excursión corta y regreso el día 12.", completo: "Ampliar hasta el 13 con Vigo, Ribeira Sacra o una etapa intermedia." },
  },
] as const;
...
const events: EventItem[] = [
  ...
  { date: "1 AGO", place: "A GUARDA", title: "Galifornia Beat", time: "DÍA Y NOCHE", note: "Cultura urbana, música, deporte y ocio en el puerto, junto al skate park. Es una buena opción para animar la primera jornada gallega sin alejarse del camping.", coords: [41.9017, -8.8796], url: "https://www.aguarda.es/o-galifornia-beat-regresa-os-dias-31-de-xullo-e-1-de-agosto-para-converter-a-guarda-en-epicentro-da-cultura-urbana/" },
  { date: "1–2 AGO", place: "BAIONA", title: "Festas Patronais da Anunciada", time: "TARDE–NOCHE", note: "Jornadas finales de las fiestas patronales en el Parque da Palma, con verbenas y orquestas. Consultar el programa Baiverán antes de desplazarse.", coords: [42.1198, -8.8508], url: "https://www.baiona.gal/avisos-importantes-es/mas-de-150-actividades-cinco-parroquias-cuatro-meses-de-programacion-y-un-unico-objetivo-que-baiona-vuelva-a-ser-el-gran-escenario-cultural-del-verano-gallego/" },
  { date: "1–10 AGO", place: "BAIONA", title: "Baiverán · exposiciones de agosto", time: "12:00–14:00 / 18:00–22:00", note: "«As cores de Baiona» en Capitanía Marítima y, desde el día 3, «Materiais, formas e cores da natureza» en el Multiusos de Sabarís. Plan cultural útil con lluvia.", coords: [42.119, -8.849], url: "https://www.baiona.gal/wp-content/uploads/2026/06/Baiveran-2026-Castellano.pdf" },
  { date: "1–7 AGO", place: "TUI", title: "Verán Cultural · semana de agosto", time: "HORARIO SEGÚN ACTIVIDAD", note: "Programación municipal de música, cine y gastronomía. Encaja como alternativa de tarde o de lluvia durante los días de Baixo Miño.", coords: [42.046, -8.6444], url: "https://tui.gal/gl/axenda/veran-cultural-agosto" },
  { date: "4 AGO", place: "VILA NOVA DE CERVEIRA", title: "O Mundo a Dançar", time: "22:00", note: "Gala internacional gratuita en la Praça Alto Minho con grupos de Brasil, Ecuador, Serbia y Taiwán. Muy buena noche para combinar Cerveira y el Miño.", priority: true, coords: [41.9414, -8.7423], url: "https://www.cm-vncerveira.pt/pages/349?event_id=2942" },
  { date: "7–8 AGO", place: "VILA NOVA DE CERVEIRA", title: "Sons no Terreiro", time: "21:30", note: "Conciertos gratuitos al aire libre en la plaza principal, con artistas de la región y estilos variados. Ideal después del traslado hacia Santa Tecla.", coords: [41.9411, -8.7428], url: "https://www.cm-vncerveira.pt/pages/349?event_id=2943" },
  { date: "9 AGO", place: "VILA NOVA DE CERVEIRA", title: "Feira de Artes e Velharias", time: "MAÑANA–TARDE", note: "Mercado de artesanía, antigüedades y objetos tradicionales en el centro histórico. Puede sustituir Baiona si se prefiere un día tranquilo junto al Miño.", coords: [41.9413, -8.7426], url: "https://www.cm-vncerveira.pt/pages/349?event_id=2937" },
...
const waterWalks = [
  ...
  {
    base: 1, title: "PR9 MTR · Trilho das 7 Lagoas do Gerês", difficulty: "MEDIA", distance: "10,1 KM", elevation: "+300 M APROX.", shape: "CIRCULAR / VARIANTE", time: "3–3,5 H",
    note: "Desde Xertelo hasta los Poços Verdes do Sobroso. El firme no es técnico, pero la distancia, el desnivel, la roca y la escasa sombra hacen que la dificultad real sea media.",
    start: [41.73446, -8.01075], url: "https://www.outdooractive.com/en/route/hiking-trail/parque-nacional-da-peneda-geres/pr9-mtr-green-well-trail-sete-lagoas-/64769195/", source: "PR9 + TRACK", bath: "LAGOAS NATURALES · SIN VIGILANCIA",
  },
  {
...
const routePractical: Record<string, { terrain: string; shade: string; signs: string; parking: string; caution: string }> = {
  ...
  "PR9 MTR · Trilho das 7 Lagoas do Gerês": { terrain: "Pista, camino pedregoso, levada y sendero de montaña.", shade: "Baja–media.", signs: "PR9 señalizado; descargar el track antes de salir.", parking: "Entrada de Xertelo, sin bloquear calles ni accesos vecinales.", caution: "Ruta aislada y calurosa; roca resbaladiza junto a las lagoas y regreso exigente después del baño." },
...
const routeAdvanced: Record<string, { shade: string; coverage: string; water: string; best: string; real: string; shortcut: string }> = {
  ...
  "PR9 MTR · Trilho das 7 Lagoas do Gerês": { shade: "25 % aprox.", coverage: "Irregular o inexistente en tramos encajados.", water: "Llevar 2 l por persona; no beber de las lagoas.", best: "Salida 07:30–08:30.", real: "Media: unos 10 km, +300 m, firme pedregoso y exposición al calor.", shortcut: "Regresar por el mismo camino desde el primer mirador o antes del descenso a las lagoas." },
...
const bathDetails: Record<string, { watched: string; access: string; parking: string; shade: string; picnic: string; food: string; swim: string; risk: string; quality: string }> = {
  ...
  "PR9 MTR · Trilho das 7 Lagoas do Gerês": { watched: "Sin vigilancia", access: "Medio; 5 km aprox. hasta las lagoas", parking: "Pequeño en Xertelo", shade: "Baja–media", picnic: "Sin mesas ni servicios garantizados", food: "Servicios limitados en Xertelo/Cabril", swim: "Solo con caudal estable y acceso seguro", risk: "Aislamiento, roca resbaladiza, profundidad y cambios de caudal", quality: "https://apambiente.pt/agua/aguas-balneares" },
...
const explore: ExploreItem[] = [
  ...
  { name: "Parque das Termas · Vila do Gerês", type: "interés", base: 1, coords: [41.7288, -8.16203], note: "Jardín termal de árboles centenarios atravesado por el río Gerês. Plan tranquilo o alternativa parcial con calor; comprobar acceso y piscinas.", location: "Vila do Gerês", specialty: "Parque histórico, sombra y entorno termal", hours: "Horario y acceso variables; comprobar antes de salir", price: "Parque/piscinas sujetos a condiciones del complejo", visitTime: "60–120 min", categories: ["lluvia-parcial"], url: "https://www.aguasdogeres.pt/en/swimming-pool-and-pools" },
  { name: "Cascata da Portela do Homem", type: "fluvial", base: 1, coords: [41.80366, -8.12804], note: "Cascada junto a la Mata de Albergaria. Aparcar en la frontera y retroceder unos 500 m a pie; roca resbaladiza y acceso condicionado en verano.", url: "https://turismo.cm-terrasdebouro.pt/listings/cascata-da-portela-do-homem/" },
  { name: "Bamboo & Coconut Park", type: "interés", base: 1, coords: [41.65302, -8.40693], note: "Espacio de ocio, restauración y playa fluvial junto al Cávado, en Amares. Buen desvío para comer o descansar camino de Braga; confirmar horario, precio y reservas.", location: "Amares · Braga", specialty: "Jardín tropical, restauración y ocio fluvial", hours: "Variable según día y eventos; comprobar web", price: "Entrada/consumo variable", visitTime: "90–180 min", categories: ["lluvia-parcial"], url: "https://www.lagodoscisnespark.com/" },
  ...
  { name: "Praia do Camarido / Foz do Minho", type: "playa", base: 2, coords: [41.86725, -8.86247], note: "Arenal entre el Atlántico y la desembocadura del Miño, rodeado por la Mata Nacional do Camarido. Encaja con Caminha y permite elegir zona de mar o de río.", url: "https://www.visitportugal.com/en/NR/exeres/F483BA3D-FDA1-46A5-99FB-6FCE95E18045" },
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (saved === 11 || saved === 12 || saved === 13) setTripLength(saved);
  }, []);
      ...
      try {
        ...
        for (const base of bases) {
          ...
          url.search = new URLSearchParams({
            ...
            start_date: "2026-08-01", end_date: "2026-08-11", timezone: "Europe/Lisbon",
  ...
  function weatherAdvice(day: string) {
    ...
    if (value.rain <= 25 && value.wind < 28 && [6, 7, 10].includes(Number(day))) return "Buen día para costa y baño, comprobando bandera y corrientes.";
    if (value.rain <= 30 && [2, 3, 4].includes(Number(day))) return "Condiciones favorables para Peneda–Gerês y el Alto Minho; empezar temprano.";
  ...
  function printPlanning() {
    ...
    </style></head><body><h1>NORTE DE PORTUGAL<br>PLANNING · 1–11 AGOSTO 2026</h1>
  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      await Promise.all(dayRoutes.map(async (route) => {
        ...
        L.polyline(geometry, {
          color: route.color,
          weight: route.day === "01" || route.day === "11" ? 3 : 5,
          opacity: route.day === "01" || route.day === "11" ? 0.58 : 0.84,
                          ...
                          <section className="weather-card">
                            ...
                            {weather[route.day] ? (
                              <>
                                ...
                                {[6, 7, 10].includes(Number(route.day)) && <a href="https://www.meteoblue.com/es/tiempo/marine" target="_blank" rel="noreferrer">COMPROBAR OLEAJE Y VIENTO MARINO ↗</a>}
                                {[2, 3, 4].includes(Number(route.day)) && <p className="flow-warning">⚠ La previsión no mide el caudal: tras tormentas o lluvia aguas arriba, evitar pozas y pasarelas aunque haga sol.</p>}
                              </>
