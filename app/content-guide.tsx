...
const dayDecisions = [
  { day: "01", title: "Vitoria → Lima Escape", must: "Llegar con luz y montar sin prisas.", skip: "No añadir visitas largas en ruta.", rain: "Parada cubierta en Allariz o Braga si el tiempo obliga.", crowd: "Salida antes de las 08:00 para evitar tráfico y calor.", night: "Cena sencilla y descanso en el camping." },
  { day: "02", title: "Soajo + Lindoso", must: "Espigueiros de Soajo, Poço Negro y castillo de Lindoso.", skip: "Poço da Gola si Poço Negro ya está lleno o el día va tarde.", rain: "Aldeas, castillo y centro interpretativo; sin pozas.", crowd: "Soajo antes de las 09:30; aparcamientos pequeños.", night: "Folclore en Arcos si queda energía." },
  { day: "03", title: "Sistelo + Arcos", must: "Bancales de Sistelo y un tramo de la Ecovia do Vez.", skip: "No completar la ecovía lineal sin taxi o segundo coche.", rain: "Centro de Arcos, Paço de Giela y cafés junto al Vez.", crowd: "Sistelo temprano; Arcos funciona mejor al final de la tarde.", night: "Cantares ao Desafio en Arcos." },
  { day: "04", title: "Braga → Cabedelo", must: "Bom Jesus, Sé y casco histórico.", skip: "Sameiro si el traslado se retrasa.", rain: "Es el mejor día cultural con lluvia: iglesias, museos y mercado.", crowd: "Bom Jesus antes de las 10:00; sumar 30 min de aparcamiento.", night: "Atardecer corto en Cabedelo después de montar." },
  { day: "05", title: "Viana + Santa Luzia", must: "Centro, Gil Eannes, Santa Luzia y cena en Viana.", skip: "Mirador si la cima está completamente cubierta.", rain: "Gil Eannes, Museu do Traje y cafés del centro.", crowd: "Aparcar una vez y recorrer Viana a pie.", night: "Paseo iluminado por la ribera o NEOPOP si interesa." },
  { day: "06", title: "Costa norte", must: "Elegir dos playas, no intentar verlas todas.", skip: "Moledo con viento fuerte: sustituir por Caminha o Vila Praia de Âncora.", rain: "Caminha, Cerveira, museo y comida larga.", crowd: "Afife antes de las 10:30; N13 lenta en agosto.", night: "SonicBlast o sardinas en Âncora." },
  { day: "07", title: "Valença + Tui", must: "Fortaleza de Valença, puente internacional y casco de Tui.", skip: "Compras largas si todavía hay que montar la tienda.", rain: "Catedral de Tui, museos y comer bajo soportales.", crowd: "Aparcar fuera de la fortaleza; prever cortes por fiestas.", night: "Sons no Terreiro en Cerveira a las 21:30." },
  { day: "08", title: "Santa Trega + A Guarda", must: "Castro, dos miradores y puerto.", skip: "Subida a pie con niebla cerrada o calor fuerte.", rain: "MASAT, museo del castro y ruta gastronómica por el puerto.", crowd: "Subir antes de las 10:00 o a última hora.", night: "Puesta de sol en O Muíño o concierto en Valença." },
  { day: "09", title: "Oia + Mougás + Baiona", must: "Monasterio de Oia, Cabo Silleiro y paseo de Monterreal.", skip: "Pozas de Mougás tras lluvia o si la roca está húmeda.", rain: "Oia y Baiona; exposiciones Baiverán.", crowd: "Baiona por la tarde requiere margen de aparcamiento.", night: "Cena de pescado en A Guarda y paseo del puerto." },
  { day: "10", title: "Regreso", must: "Desmontar temprano y hacer dos descansos reales.", skip: "No añadir rutas antes de 650 km de conducción.", rain: "Regreso directo.", crowd: "Salir antes de las 10:00.", night: "Llegada y descarga básica; diario del viaje otro día." },
];
